...
legal_envs = (
    ...
    "ant_u5_maze_eval",
    "ant_u5_branch1_maze",
    "ant_u5_branch1_maze_eval",
    "ant_u_medium_maze",
    "ant_u_medium_maze_eval",
    "ant_u_medium_detour_maze",
    "ant_u_medium_detour_maze_eval",
    "ant_u_medium_branch_maze",
    "ant_u_medium_branch_maze_eval",
    "ant_u_medium_false_path_maze",
    "ant_u_medium_false_path_maze_eval",
    "ant_u_medium_max_length_maze",
    "ant_u_medium_max_length_maze_eval",
    "ant_u_medium_eht_maze",
    "ant_u_medium_eht_maze_eval",
    "humanoid_u_maze",
    "humanoid_big_maze",
